...
## and plots a graphic with the Global Active Power and time. 
## .
##
######################################################################
plot2 <- function (rds_path = "") {
  message("Executing!")
  #####################################################
  ...
  plot(comdata1$Global_active_power~as.POSIXct(comdata1$Time), type='l',ylab = "Global Active Power (kilowatts)",xlab= "",cex.axis=0.8, cex.lab=0.8)
  dev.off()
  message("Graphic saved as plot2.png in the current working directory")
}
